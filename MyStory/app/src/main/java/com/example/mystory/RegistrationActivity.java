...
public class RegistrationActivity extends AppCompatActivity {
    TextInputEditText mNewUserName;
    TextInputEditText mNewUserPassword;
    TextInputEditText mNewUserPassword2;
    String _mNewUserName;
    String _mNewUserPassword;
    String _mNewUserPassword2;
