...
public class PhotoActivity extends AppCompatActivity {
    final int REQUEST_CODE_CAMERA = 120;
    final int FROM_CAMERA = 121;
    final int FROM_GALLERY = 122;

    ImageView mPhoto;
    TextInputEditText mQuote;
    String _mQuote = "default quote";
    Button mGetQuote;
    Button mUpload;
    int mOption;
    Bitmap mImage;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK && data != null) {
            ...
            if (requestCode == FROM_CAMERA) {
                ...
                mImage = Bitmap.createScaledBitmap(mImage, 230, 230, false);
